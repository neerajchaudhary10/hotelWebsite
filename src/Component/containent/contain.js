        ...
        {showPages === "home" && (
          <div className="about">
            ...
            <div className="detail">
              ...
              <h1 style={{ color: "brown" }}>WELCOME TO HOTEL P.L PALACE</h1>
              <h3>
                P.L Group of Hotels is a progressive name in the arena of
                hospitality industry of the beautiful agra city. P.L Hotel Agra
              ...
              <h3>
                P.L hotel Agra offer star facilities in star hotels in agra
